package UNIDAD8.XMLconSTAX.Escritura;
...
public class EscrituraXMLStax {
    public static void main(String[] args) {
        ...
        try {
            ...
            XMLEventWriter xmlWriter = xmlOutputFactory.createXMLEventWriter(new FileOutputStream("JAVA/src/main/java/UNIDAD8/XMLconSTAX/Escritura/pedidos_nuevos.xml"));
