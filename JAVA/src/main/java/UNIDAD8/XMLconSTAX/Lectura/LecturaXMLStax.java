package UNIDAD8.XMLconSTAX.Lectura;
...
public class LecturaXMLStax {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            XMLEventReader xmlReader = xmlInputFactory.createXMLEventReader(new FileInputStream("JAVA/src/main/java/UNIDAD8/XMLconSTAX/Lectura/pedidos.xml"));
                ...
                if (xmlEvent.isStartElement()) {
                    ...
                    switch (tagName) {
                        case "pedido" :
                            ...
                            pedidoActual.setId(Integer.valueOf(id.getValue()));
                    ...
                    if (!tagActual.equals("")) {
                        switch (tagActual) {
                            ...
                            case "fecha" :
                                ...
                                break;
                            case "precio" :
                                pedidoActual.setPrecio(Double.valueOf(texto.getData()));
                                break;
                            case "cantidad" :
                                pedidoActual.setCantidad(Integer.valueOf(texto.getData()));
                                break;
                        }
                    }
                }
